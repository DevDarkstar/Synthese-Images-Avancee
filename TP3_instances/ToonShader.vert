...
void main(){
    ...
    // Passage de la normal de l'espace local à l'espace global
    // en utilisant la transposée inverse de la partie linéaire de la matrice modèle
    vs_out.Normal = transpose(inverse(mat3(MODEL))) * normal;
    // Passage des coordonnées de texture du sommet au fragment shader
