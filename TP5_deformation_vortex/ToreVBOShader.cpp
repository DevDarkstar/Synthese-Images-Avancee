...
void getUniformLocationPhong(PhongIDs& phong){
  ...
  phong.locX0 = glGetUniformLocation(phong.programID, "vortex.x0");
  phong.locX1 = glGetUniformLocation(phong.programID, "vortex.x1");
  phong.locThetaMax = glGetUniformLocation(phong.programID, "vortex.thetaMax");
}
...
//----------------------------------------
{
  ...
  glutCreateWindow("ROTATION VORTEX AXE X");
